    ...
    return (
        <div className='relative overflow-auto'>
            ...
            <div className='px-4 py-8'>
                <table className='border-collapse border border-cafeteria-300 h-60 lg:h-80 -my-5'>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td className='border border-cafeteria-200 w-60 text-center'>X=Adulto</td>
                            <td className='border border-cafeteria-200 w-60 text-center'>Caliente</td>
                            <td className='border border-cafeteria-200 w-60 text-center'>Caliente</td>
                            <td className='border border-cafeteria-200 w-60 text-center'>Caliente</td>
                        </tr>
                        ...
                        <tr>
                            <td className='border border-cafeteria-200 w-60 text-center'>X=Mayor</td>
                            <td className='border border-cafeteria-200 w-60 text-center'>Caliente</td>
                            <td className='border border-cafeteria-200 w-60 text-center'>Caliente</td>
                            <td className='border border-cafeteria-200 w-60 text-center'>Caliente</td>
                        </tr>
